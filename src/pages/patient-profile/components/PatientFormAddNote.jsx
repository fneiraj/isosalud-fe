...
const PatientFormAddNote = ({
  ...
  const formik = useFormik({
    ...
    initialValues: currentNote || initProductData,
    validationSchema:
      Yup.object().shape({
          ...
          <div>
            ...
            <div style={{ bottom: 30, right: 15, position: 'absolute' }} className={classes.buttonGroup}>
              ...
              <Button
                ...
                className={classes.button}
              >
                {currentNote !== undefined ? 'Actualizar' : 'Agregar'}
              </Button>
            </div>
          </div>
        </Paper>
...
export default withStyles(styles)(PatientFormAddNote)
