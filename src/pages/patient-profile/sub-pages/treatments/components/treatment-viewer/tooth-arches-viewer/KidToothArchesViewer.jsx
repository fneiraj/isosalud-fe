...
const KidToothArchesViewer = () => {
  ...
  return (
    <>
      ...
      <path
        className="child-tooth-72 child-tooth-72-parent "
      ...
      <path
        className="child-tooth-73 child-tooth-73-parent "
      ...
      <path
        className="child-tooth-74 child-tooth-74-parent "
      ...
      <path
        className="child-tooth-75 child-tooth-75-parent "
      ...
      <path
        className="child-tooth-81 child-tooth-81-parent "
      ...
      <path
        className="child-tooth-82 child-tooth-82-parent "
      ...
      <path
        className="child-tooth-83 child-tooth-83-parent "
      ...
      <path
        className="child-tooth-84 child-tooth-84-parent "
      ...
      <path
        className="child-tooth-85 child-tooth-85-parent "
...
export default KidToothArchesViewer